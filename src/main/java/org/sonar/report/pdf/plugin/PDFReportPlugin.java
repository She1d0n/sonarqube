...
@Properties({
		...
		@Property(key = PDFPostJob.WAITING_TIME, name = "Time", description = "Time to wait for Compute Engine task.(minute)", defaultValue = PDFPostJob.TIME_DEFAULT_VALUE, global = true, project = true, module = false),
